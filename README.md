# Rihal CodeStacker 2026 Challenges
...
### ✅ Frontend (FE)
See the full FE challenge here:
...
- You can submit a solution to one or both challenges. If you submit both, please include both repository links in a single email.
